            ...
            <div className="columns">
                <div className="column">
                    ...
                    <div className="mt30 agendaTable mt30">
                        <table>
                            <tr >
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Month</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Total Hours</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Independent</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Supervised</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Supervised</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Supervision %</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Restricted</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Unrestricted</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Unrestricted %</th>
                                <th className="agendaTableHeader" style={{ border: "1px solid #B7B7B7" }}>Type</th>
                            </tr>
