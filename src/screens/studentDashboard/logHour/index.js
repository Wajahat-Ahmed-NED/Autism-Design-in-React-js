    ...
    <div className="section">
      <div className="columns ">
        <div className="column">
          ...
          <p className='headingMain headMain' style={{ overflowWrap: "break-word", }}>Log Experience Hours</p>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div className='mt30 monthCard' >
              <p className='month'>June 2022</p>
              <div className="mt10 totalHours">
                <p>25000 Total Hours</p>
                <p>Independent: 21000 | Supervised: 4000</p>
              </div>
              <div style={{ textAlign: "left" }} className="mt10">
                <p className="font"><CheckCircleIcon className='colored' fontSize="1px" />&nbsp; &nbsp;Minimum 20 Total Hours</p>
                <br />
                <p className="withoutcolor"><CheckCircleIcon className='colored hidden' fontSize="1px" />&nbsp; &nbsp;Maximum 130 Total Hours</p>
                <br />
                <p className='font'><CheckCircleIcon className='colored' fontSize="1px" />&nbsp; &nbsp;Minimum 5% Supervision of Total Hours</p>
                <br />
                <p className="withoutcolor"><CheckCircleIcon className='colored hidden' fontSize="1px" />&nbsp; &nbsp;Minimum 4 Total Contracts</p>
                <br />
                <p className='font'><CheckCircleIcon className='colored' fontSize="1px" />&nbsp; &nbsp;Maximum 50% Group of Total Supervision Hours</p>
                <br />
                <p className='font'><CheckCircleIcon className='colored' fontSize="1px" />&nbsp; &nbsp;Minimum 1 Observation with Client</p>
                <br />
              </div>
            </div>
          </div>
